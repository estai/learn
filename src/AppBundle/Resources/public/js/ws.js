var WS = (function()
{
     ...
     */
    WSSocket.prototype.on = function(type, listener){
     ...
     * @param {String} event
     */
    WSSocket.prototype.fire = function(event){
     ...
     * @param {function} listener
     */
    WSSocket.prototype.off = function(type, listener){
